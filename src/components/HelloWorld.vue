...
Other Jewellery: Regenerate (13-16) Life per second
--------
...
Armour: 112 (augmented)
Evasion Rating: 112 (augmented)
--------
Requirements:
Level: 54
Str: 40
...
+17 to Strength
36% increased Armour and Evasion
...
Physical Damage: 319-663 (augmented)
...
17% increased Armour, Evasion and Energy Shield (crafted)
...
--------
+36 to Intelligence (implicit)
--------
+32 to all Attributes
Adds 10 to 22 Physical Damage to Attacks
+71 to maximum Life
+15% to Chaos Resistance
+11% to Lightning and Chaos Resistances (crafted)
`, `Rarity: Unique
Lion's Roar
Granite Flask
--------
...
Int: 114
--------
Supports any channelling skill, protecting you from damage while you channel it. Cannot support Minions that channel skills.
--------
Totems cannot gain Infusion
Infusion lasts 6 seconds after you finish Channelling
Gain Infusion after Channelling a Supported Skill for 0.9 seconds
...
Item Level: 80
--------
Malevolence has 15% increased Aura Effect (implicit)
--------
...
Shift click to unstack.
`, `Rarity: Rare
<<set:MS>><<set:M>><<set:S>>Beast Grinder
Abyssal Sceptre
--------
Sceptre
Physical Damage: 58-94 (augmented)
Elemental Damage: 2-26 (augmented)
Critical Strike Chance: 8.30% (augmented)
...
Item Level: 72
--------
30% increased Elemental Damage (implicit)
--------
+23 to Intelligence
Adds 13 to 27 Physical Damage
Adds 2 to 26 Lightning Damage
34% increased Critical Strike Chance
Enemies have -8% to Total Physical Damage Reduction against your Hits
