<template>
  <div class="py-2 border-b border-line flex flex-col">
    <div class="pb-1 flex items-baseline">
      <i class="w-5 shrink-0 fas fa-exclamation-triangle text-warn-text"></i>
    ...
    <div class="ml-5 text-xs leading-none">
      <span class="text-content-muted">{{ t(stat.type) }} &mdash; </span>
      <span class="text-warn-text">{{ t('Not recognized modifier') }}</span>
    </div>
  </div>
</template>
