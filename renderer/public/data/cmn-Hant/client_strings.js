...
export default {
  ...
  ELDRITCH_MOD_R6: '完美',
  SENTINEL_CHARGE: '充能: ',
  SHAPER_MODS: ["塑者之","塑者的","塑界者的","高尚塑者的","高尚塑者之"],
  ELDER_MODS: ["尊師之","尊師的","高尚尊師的","高尚尊師之"],
  CRUSADER_MODS: ["聖戰士的","聖戰士之","高尚聖戰士的","高尚聖戰士之"],
  HUNTER_MODS: ["狩獵者的","狩獵者之","高尚狩獵者的","高尚狩獵者的之"],
  REDEEMER_MODS: ["救贖者之","救贖者的","高尚救贖者的","高尚救贖者之"],
  WARLORD_MODS: ["總督軍的","征服之","高尚總督軍的","高尚征服之"],
  DELVE_MODS: ["地下的","地下之"],
  VEILED_MODS: ["被選召的","教團之","里歐的","卡塔莉娜的","艾爾雷恩的","瓦里西的","哈庫的","托菈的","瓦甘的","布琳洛特","傑納斯之","它的","西拉克之","格拉維奇的","喬恩的","庫歐的","琳的","卡麥歷亞之","愛斯林之","萊可之"],
