...
export default {
  ...
  HEIST_ESCAPE_ROUTES: '已揭露逃脫路線: ',
  HEIST_REWARD_ROOMS: '已揭露暗房: ',
  HEIST_ITEM_QUANTITY: '物品數量: ',
  HEIST_ITEM_RARITY: '物品稀有度: ',
  HEIST_CONTRACT_REQUIRED: '需要 ',
  HEIST_CONTRACT_REQUIRED_DEPARTMENT_LEVEL: /^需要 (.+?) \(等級 (\d+)(?:\s*\(unmet\))?\)/,
  HEIST_DEPARTMENT_MAP: {
    '開鎖': 'Lockpicking',
    '蠻力': 'Brute Force',
    '洞察力': 'Perception',
    '拆除': 'Demolition',
    '解咒師': 'Counter-Thaumaturgy',
    '陷阱解除': 'Trap Disarmament',
    '靈敏': 'Agility',
    '詐欺': 'Deception',
    '工程': 'Engineering',
  },
