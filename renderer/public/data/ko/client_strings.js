...
export default {
  ...
  HEIST_ESCAPE_ROUTES: '탈출 경로 드러남: ',
  HEIST_REWARD_ROOMS: '보물 창고 드러남: ',
  HEIST_ITEM_QUANTITY: '아이템 수량: ',
  HEIST_ITEM_RARITY: '아이템 희귀도: ',
  HEIST_CONTRACT_REQUIRED: '',
  HEIST_CONTRACT_REQUIRED_DEPARTMENT_LEVEL: /^(.+?) 필요\((\d+)(?:\s*\(unmet\))?레벨\)/,
  HEIST_DEPARTMENT_MAP: {
    '자물쇠 따기': 'Lockpicking',
    '완력': 'Brute Force',
    '통찰력': 'Perception',
    '파괴 공작': 'Demolition',
    '반-마석학': 'Counter-Thaumaturgy',
    '덫 해제': 'Trap Disarmament',
    '민첩함': 'Agility',
    '기만': 'Deception',
    '공학': 'Engineering',
  },
