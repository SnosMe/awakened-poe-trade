...
export default {
  ...
  ELDRITCH_MOD_R6: '완벽한',
  SENTINEL_CHARGE: '충전: ',
  SHAPER_MODS: ["- 형성","쉐이퍼의","고양된 쉐이퍼의","- 고양된 형성"],
  ELDER_MODS: ["- 엘더","엘더의","고양된 엘더의","- 고양된 엘더"],
  CRUSADER_MODS: ["십자군의","- 십자군","고양된 십자군의","- 고양된 십자군"],
  HUNTER_MODS: ["사냥꾼의","- 사냥꾼","고양된 사냥꾼의","- 고양된 사냥꾼"],
  REDEEMER_MODS: ["- 구원","대속자의","고양된 대속자의","- 고양된 구원"],
  WARLORD_MODS: ["전쟁군주의","- 점령자","고양된 전쟁군주의","- 고양된 점령자"],
  DELVE_MODS: ['지하의','- 지하'],
  VEILED_MODS: ["선택","- 질서","선택받은","레오의","카타리나의","엘레온의","보리치의","하쿠의","토라의","베이건의","부패한 염수단","- 야누스","그것의","- 힐록","그라비시우스의","요르긴의","코렐의","린의","- 카메리아","- 아이슬링","- 라이커"],
