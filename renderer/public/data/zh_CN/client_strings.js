...
export default {
  ...
  METAMORPH_HELP: '在丹恩的实验室將此与其他四个不同的样本合成。',
  ...
  MIRRORED: '已复制',
  MODIFIER_LINE: /^(?<type>[^"]+)(?:\s+"(?<name>[^"]+)")?(?:\s*\(级别：(?<tier>\d+)\))?(?:\s*\(等级：(?<rank>\d+)\))?$/,
  PREFIX_MODIFIER: '前綴',
  SUFFIX_MODIFIER: '后綴',
  CRAFTED_PREFIX: '大师工艺前綴',
  CRAFTED_SUFFIX: '大师工艺后綴',
  UNSCALABLE_VALUE: ' — 无法使用的值',
