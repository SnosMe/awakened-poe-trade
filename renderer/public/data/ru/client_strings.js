...
export default {
  ...
  HEIST_CONTRACT_REQUIRED: 'Требуется ',
  HEIST_CONTRACT_REQUIRED_DEPARTMENT_LEVEL: /^Требуется (.+?) \((\d+)(?:\s*\(unmet\))? уровень\)/,
  HEIST_DEPARTMENT_MAP: {
    'взлом': 'Lockpicking',
    'грубая сила': 'Brute Force',
    'контрчародейство': 'Counter-Thaumaturgy',
    'маскировка': 'Deception',
    'взрывное дело': 'Demolition',
    'инженерное дело': 'Engineering',
    'проворство': 'Agility',
    'восприятие': 'Perception',
    'разминирование': 'Trap Disarmament',
  },
  MIRRORED: 'Отражено',
  SPLIT: 'Разделено',
