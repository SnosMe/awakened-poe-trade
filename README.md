# ![Awakener's Orb](https://web.poecdn.com/image/Art/2DItems/Currency/TransferOrb.png) Awakened PoE Trade that support simplified chinese(zh_CN)
支持中文简体搜索, 加入对国服支持, 可以在国服上查询物价。由于是首次支持简体中文，没有经过充分测试，或许会有问题，欢迎反馈。
